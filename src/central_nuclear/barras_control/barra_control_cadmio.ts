...
export default class BarraControlCadmio extends BarraControl implements IMecanismoDeControl {
  constructor(tiempoVidaUtilTotal: number = 3600, estado: EstadoBarraControl = new EnDesuso()) {
    super();
  }
}
